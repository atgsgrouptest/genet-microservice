...
async def run_web_test(req: RequestFromGo, db):
    ...
    for idx, case in enumerate(req.positiveCases):
        ...
        try:
            ...
            agent = Agent(
                task=task,
                llm=ChatOpenAI(model="gpt-4.1-nano", api_key=REMOVED_SECRET),
                use_vision=True,
    ...
    # 👎 Negative Cases
    print(f"Processing {len(req.negativeCases)} negative case groups...okkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk")
